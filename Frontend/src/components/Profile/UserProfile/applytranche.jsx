...
const Applytranche = ({ text, text1, imageSrc, imageAlt, navigateTo }) => {
  ...
  return (
    <div
      className="max-w-lg flex relative justify-between items-start mt-6 p-2 rounded-xl bg-gradient-to-r from-blue-900 to-purple-400 transition-transform duration-300 ease-in-out hover:scale-105 cursor-pointer"
